...
<html>
  ...
  <!-- Facebook and Twitter integration -->
				...
				<div class="row">
					...
					<div class="col-md-10 text-right menu-1">
						<ul>
							...
							<li class="active"><a href="gallery.php">GALERİ</a></li>
	...
	<div class="site-section" style="padding-bottom: 0em;">
		<div class="container">
			<div class="row" style="    margin-bottom: 200px;">
			<h1 class="col-md-8 col-md-offset-2 text-center ftco-heading" style="margin-bottom: 2em;">Resimler</h1>
				...
				<div class="col-sm-6 col-md-6 col-lg-4">
					<a href="panel/pages/<?= $row['resim'] ?>"  class="image-popup gallery-item"><img style="height: 300px; width:400px;" src="panel/pages/<?= $row['resim'] ?>" alt="Image" class="img-responsive"></a>
				</div>
